...
from .confs import CNNBlockConfig, PatchEmbConfig
from ...modules.cnn.cnn_base import ConvBlockSequential
from ...modules.cnn.resnet import ResBlockSequential
from ...modules.cnn.cnn_base import PatchEmbedderND, LinearUnpatchify, ConvUnpatchify, EmbedBlockSequential
...
class CNN(nn.Module):
    ...
    def __init__(
        ...
        self.concat_cond: bool = concat_cond
        self.dims: int = len(patch_emb_config.patch_emb_size)
        ...
        self.encoder: EmbedBlockSequential = EmbedBlockSequential(*enc_blocks)
        self.processor: EmbedBlockSequential = EmbedBlockSequential(*prc_blocks)
        self.decoder: EmbedBlockSequential = EmbedBlockSequential(*dec_blocks)

        # Define output unpatchifying layer
        if patch_emb_config.block_type == "ConvBlock":
            self.out: nn.Module = RearrangeConvCentric(ConvUnpatchify(out_ch, final_out_ch,
