...
class LightningNOVAE(pl.LightningModule):
    ...
    def __init__(self, model: no_vae, lr: float, lr_warmup: Optional[int] = None, ema_rate: float = 0.999,
        ...
        """
        super().__init__()
        self.model: no_vae = model  # Main VAE model
