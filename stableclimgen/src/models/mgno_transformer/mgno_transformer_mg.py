    ...
    def __init__(self, 
        ...
        for block_idx, block_conf in enumerate(block_configs):
            ...
            if isinstance(block_conf, MGEncoderDecoderConfig):
                block = MGNO_EncoderDecoder_Block(
                                            ...
                                            mg_reduction_embedder_names=check_get(block_conf, kwargs,defaults, "mg_reduction_embedder_names"),
                                            mg_reduction_embedder_names_mlp=check_get(block_conf, kwargs,defaults, "mg_reduction_embedder_names_mlp"),
                                            ...
                                            embedder_names=check_get(block_conf, kwargs,defaults, "embedder_names"),
       ...
       # self.out_layer = nn.Linear(input_dims[0], output_dim, bias=False)
        ...
        self.input_layer = InputLayer(self.input_dim,
                                      lifting_dim, 
                                      self.grid_layer_0, 
                                      embedder_names=kwargs.get('input_embedder_names',defaults['input_embedder_names']),
