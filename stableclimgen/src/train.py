...
def train(cfg: DictConfig):
    ...
    # define data sets
    with open(cfg.data.dataset.data_dir_dict) as json_file:
        data = json.load(json_file)
    train_dataset = instantiate(cfg.data.dataset, data_dir_dict=data["train"])
    val_dataset = instantiate(cfg.data.dataset, data_dir_dict=data["val"])

    train_dataloader: DataLoader = instantiate(cfg.data.dataloader, dataset=train_dataset)
    val_dataloader: DataLoader = instantiate(cfg.data.dataloader, dataset=val_dataset)
